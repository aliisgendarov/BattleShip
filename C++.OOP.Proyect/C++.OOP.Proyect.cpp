					...
					while (isRunning)
					{
						...
						case Enter:
							...
							case 2:
							{
								...
								string currentPlayerType = (currentPlayer == 1) ? p1.getPlayer() : p2.getPlayer();

								if (currentPlayerType != "Manual")
								{
								...
								while (gameRunning)
								{
									...
									if (board->isShipCountFinished(currentShip) && board->haveShipToPut())
									...
									case KeyUp:
										...
										break;
									case KeyDown:
										if (cursorY < 9 && board->moveCheck(currentShip, 0, 1))
											cursorY++;
										break;
									case KeyLeft:
										if (cursorX > 0)
										...
										break;
									case KeyRight:
										if (cursorX < 9 && board->moveCheck(currentShip, 1, 0))
											cursorX++;
										break;
									case H:
